...
func wireApp(confServer *conf.Server, confData *conf.Data, tokenList *conf.TokenList, arg []*conf.Platform, nftList *conf.NFTList, arg2 map[string]string, logger log.Logger) (*kratos.App, func(), error) {
